...
class User(Base, ReprMixin, StrMixin):
    ...
    # Authorization 
    role: Mapped[UserRole] = mapped_column(SQLEnum(UserRole, name="user_role", native_enum=False),
    ...
    monsters: Mapped[list["Monster"]] = relationship(back_populates="owner",passive_deletes=True,)