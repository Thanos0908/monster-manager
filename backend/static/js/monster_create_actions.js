(function () {
  const jsonEl = document.getElementById("actions_json");
  const rowsEl = document.getElementById("actions-rows");
  ...
  function createRow({ name = "", text = "" } = {}) {
    ...
    nameInput.type = "text";
    nameInput.placeholder = "Action name (e.g., Bite)";
    ...
    textInput.rows = 3;
    textInput.placeholder = "Action description";
  ...
  function hydrate() {
    ...
    Array.from(rowsEl.children).forEach(r => r.__sync?.());
  }
