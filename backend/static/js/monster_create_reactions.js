(function () {
  const jsonEl = document.getElementById("reactions_json");
  const rowsEl = document.getElementById("reactions-rows");
  const addBtn = document.getElementById("reactions-add");
  ...
  function createRow({ name = "", text = "" } = {}) {
    ...
    nameInput.type = "text";
    nameInput.placeholder = "Reaction name (e.g., Parry)";
    ...
    textInput.rows = 3;
    textInput.placeholder = "Reaction description";
